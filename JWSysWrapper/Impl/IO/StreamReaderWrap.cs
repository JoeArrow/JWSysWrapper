...
namespace JWSysWrap.Impl.IO
{
    ...
    public class StreamReaderWrap : IStreamReader
    {
        ...
        { Instance = new StreamReader(stream, detectEncodingFromByteOrderMarks); }
        ...
        { Instance = new StreamReader(path, detectEncodingFromByteOrderMarks); }
        ...
        {
            return Instance.Read(buffer, index, count);
        }
        public int ReadBlock(char[] buffer, int index, int count)
        {
            return Instance.ReadBlock(buffer, index, count);
        }
