...
namespace JWWrap.Impl.Security.Certificate
{
    ...
    public class X509ChainWrap : IX509Chain
    {
        ...
        /// -----------------------------------------------
        /// <summary>
        ///     Gets a collection of IPamsX509ChainElement 
        ///     objects.
        /// </summary>
        ...
        /// -----------------------------------------------
        /// <summary>
        ///     Gets the X509ChainPolicy to use when 
        ///     building an X.509 certificate chain.
        /// </summary>
        ...
        /// -----------------------------------------------
        /// <summary>
        ///     Gets the status of each element in an 
        ///     X509Chain object.
        /// </summary>
