...
namespace JWWrap.Impl.Security.Certificate
{
    ...
    public class X509ChainElementWrap : IX509ChainElement
    {
        ...
        ///     <see cref="X509ChainElementWrap"/> class.
        /// </summary>
        ...
        public X509ChainElementWrap(IX509Certificate certificate, X509ChainStatus[] chainElementStatus)
        {
        ...
        /// -----------------------------------------------
        /// <summary>
        ///     Gets the X.509 certificate at a particular 
        ///     chain element.
        /// </summary>
        ...
        /// -----------------------------------------------
        /// <summary>
        ///     Gets the error status of the current X.509
