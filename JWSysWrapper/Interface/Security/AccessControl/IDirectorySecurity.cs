...
namespace JWWrap.Interface.Security.AccessControl
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:JWWrap.Interface.Security.AccessControl.DirectorySecurityWrap"/> class on the specified path.
        /// </summary>
